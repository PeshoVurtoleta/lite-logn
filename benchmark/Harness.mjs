/**
 * @zakkster/lite-logn -- benchmark harness (shared measurement primitives).
 *
 * Repo-only dev/measurement infra. NOT part of the published tarball (not in
 * package.json files[]), NOT imported by LogN.js, and NOT a data-structure member.
 * It profiles the four shipped members against a built-in O(n) foil across the
 * eight dimensions of the benchmark suite (D1 is the O(log n) Witness fit).
 *
